...
class LocationPage extends React.Component {
  componentDidMount() {
    this
      .props
      .updateMeta("Location | Melrose Park ", "A number of new commuter initiatives proposed will make Melrose Park one of Sydn" +
          "ey’s most connected places.");
  }
      ...
      <section>
        ...
        <div className="row">
          ...
          <div className="col col-04 ">
            <LargeP type="green">
              A number of new commuter initiatives proposed will make Melrose Park one of
              Sydney’s most connected places.
            </LargeP>
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col col-02 top ">
            ...
            <P>
              Working with Government we are planning to launch a fleet of exclusive private
              ferries to Parramatta via Sydney Olympic Park, Ermington, Rydalmere and Western
              Sydney University.
            </P>
          </div>
        ...
        <div className="row">
          ...
          <div className="col col-03 padd">
            ...
            <P>
              The NSW Government has announced the proposed extension of the Parramatta Light
              Rail, which will see light rail services connect Melrose Park and Olympic Park
              and Parramatta CBD and future West Metro Rail.
            </P>
          </div>
        </div>
        <div className="row">
          ...
          <div className="col col-03 top padd">
            <H3 icon={true}>
              Easy Connections To The Highway And Rapid Bus Services To Sydney & Parramatta.
            </H3>
            <P>
              More than 2,000 express busses service Melrose Park Residences. Buses departing
              every 5 minutes.
            </P>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col col-03">
            <H3 icon={true}>
              The future internal street car will connect residents to a new world of
              possibilities.
            </H3>
          </div>
