      ...
      <section>
        ...
        <div className="row">
          ...
          <div className="col padd col-06">
            ...
            <P>
              ...
              sweeping lawns, terraced gardens and vantage points. Bask in the expanses of
              green at the sprawling Central Park, which will feature cafes, al fresco dining,
              playgrounds and pop-up markets.{" "}
            </P>
            <P>
              Enjoy lush landscapes along the boulevard, with planted edges and avenues of
              trees, or discover floral and pocket gardens throughout Melrose Park.
            </P>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col col-04">
            ...
            <P>
              Enjoy lush landscapes along Boulevard Park, with planted edges and avenues of
              trees, play a round of golf in the leading Ryde-Parramatta Golf Club or discover
              floral and pocket gardens throughout Melrose Park.
