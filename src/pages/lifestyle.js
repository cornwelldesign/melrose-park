...
class LifestylePage extends React.Component {
  componentDidMount() {
    this.props.updateMeta(
      "Lifestyle | Melrose Park ",
      "The pulse of your new neighbourhood, Melrose Park will have everything you need for the life you want to live."
    );
  }
      ...
      <section>
        <div className="row">
          ...
          <div className="col  col-10">
            <Image
              src="/images/melrose-park-sydney-property-019-TOWN-v2.jpg"
        ...
        <div className="row">
          ...
          <div className="col col-03 padd">
            ...
            />
						            <P>
						A vibrant destination for residents and visitors alike, it will deliver a full-line supermarket, specialty grocers, cafés, restaurants, delis, bakery, gym, dry cleaner, newsagent, pharmacy, a variety of entertainment and personal services. 
            </P>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col col-04">
											<P>At Melrose Park, employment opportunities need not be far from home, with 15,000m2 of new commercial space bringing in over 1,500 full-time jobs. Young families with children will also have access to several childcare centres within Melrose Park.</P>
        ...
        <div className="row">
          ...
          <div className="col col-10">
            <Image
              src="/images/melrose-park-sydney-property-023-RETAIL-v2.jpg"
