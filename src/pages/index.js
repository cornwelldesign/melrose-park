...
class HomePage extends React.Component {
  ...
  render() {
		...
		if(window.innerWidth < 640) {
			return (
				<div><Hero image="/images/melrose-park-sydney-property-001-GARDENS.jpg" alt="Melrose Park Property, Sydney - Outside Gardens (Artists Impression)"  title={`The New Heart
						of Sydney`}  half="left"/><FocusImg
								link="/lifestyle/"
